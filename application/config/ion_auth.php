...
*/
$config['tables']['users']           = 'lunch_users';
$config['tables']['groups']          = 'lunch_groups';
$config['tables']['users_groups']    = 'lunch_users_groups';
$config['tables']['login_attempts']  = 'lunch_login_attempts';
 ...
 */
$config['site_title']                 = "Time for Lunch";       // Site Title, example.com
$config['admin_email']                = "lunch@zilifone.net"; // Admin Email, admin@example.com
